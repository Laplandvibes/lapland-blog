...
// Nykyinen koko ~168 kt. Raja on 15 % alle sen, mutta selvasti yli
// alaskannatun buildin (~90 kt), jotta normaali vaihtelu ei laukaise tata.
const MIN_BYTES = 142_000;
// Luokat jotka tulevat VAIN taman sivuston src/:sta -- ei shared/:sta.
const REQUIRED = ['bg-night-light', 'text-aurora-blue', 'from-night'];
