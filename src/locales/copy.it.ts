...
const it: SectionCopy = {
  ...
  home: {
    ...
    heroLead:
      'Segni sulla mappa il luogo in cui ha visto l’aurora. Fotografi la baita. Annoti quanti gradi c’erano. Costruisca un bel blog del Suo viaggio, uno che i Suoi amici possano davvero seguire.',
    ...
    readFirstEyebrow: 'Dal campo',
    readFirstH2: 'Tre articoli prima di fare le valigie.',
    readFirstCta: 'Tutti gli articoli',
    readFirstRead: 'Leggi',
    howEyebrow: 'Come funziona',
    howH2Pre: 'Tre passi. Un viaggio.',
    howH2Italic: 'Un blog che vale la pena conservare.',
    howLead:
      'Lapland.blog è una piattaforma gratuita per diari di viaggio pensata per chi visita la Lapponia finlandese. Il Suo viaggio diventa un blog che avrà davvero voglia di condividere.',
    howStep1Kicker: 'Passo 01 · Pianificazione',
    howStep1Title: 'Segni i luoghi sulla mappa.',
    howStep1Body:
      'Sulla mappa della Lapponia segni la baita prenotata, il ristorante che vuole provare e il punto con il cielo più buio per l’aurora. Costruisca l’itinerario prima di partire.',
    howStep2Kicker: 'Passo 02 · Diario',
    howStep2Title: 'Scriva mentre viaggia.',
    howStep2Body:
      'Dal telefono, in baita, in auto, in sauna. Aggiunga foto, temperatura, il sapore della zuppa. Ogni voce viene associata automaticamente al giorno e al luogo.',
    ...
    pillarsLead:
      'Sfogli ciò che altri viaggiatori hanno annotato, e scelga i temi che vuole raccontare nel Suo viaggio. Aurora, baite, cibo, il freddo, le persone, i silenzi nel mezzo.',
    pillar1Kicker: 'I · Il freddo',
    pillar1Title: 'Cosa fa davvero il freddo',
    pillar1Body:
      'Notti di aurora, la notte polare e quella breve ora blu a mezzogiorno. Qui il tempo è il protagonista, non lo sfondo. Appunti dal campo su cosa fa il buio a una persona e su cosa chiede alla batteria del telefono.',
    pillar2Kicker: 'II · Il riparo',
    pillar2Title: 'Dove si dorme, dove si mangia',
    pillar2Body:
      'Baite di legno, igloo di vetro, saune che funzionano e saune che non funzionano. Zuppa di salmone al prezzo scritto sul menù. Il pane di segale che sopravvive a uno zaino e il caffè che si beve alle 2 del mattino perché il sole si è dimenticato di tramontare.',
    ...
    latestEyebrow: 'Ultimi testi',
    latestH2: 'Altro dal campo.',
    ...
    asideP1:
      'Ogni anno migliaia di visitatori arrivano in Lapponia, vedono qualcosa di straordinario e lo perdono in un rullino del telefono che non riapriranno mai più. L’aurora sopra la baita. Il ritorno dalla sauna con le dita intorpidite. La zuppa di salmone che valeva il prezzo. Sparita nel giro di una settimana.',
    asideP2:
  ...
  about: {
    ...
    seedHeading: 'Chi scrive questi testi',
    seedBody:
      'I testi di questo sito li scrive la redazione di LaplandVibes: luoghi chiamati per nome, prezzi letti dal menù, fonti in fondo. I lettori scrivono i propri diari di viaggio sulla stessa piattaforma.',
  ...
  destination: {
    metaSuffix: 'Diari di viaggio e guide alle destinazioni dal network.',
    backToAll: 'Tutte le destinazioni',
    networkEyebrow: 'Altrove nel network',
    networkH2: 'Scopri di più su questa destinazione',
    networkLead: 'Lo stesso posto, più in profondità: dove dormire, dove mangiare e cosa fare, ognuno sul proprio sito.',
    siteLabels: {
      vibes: 'Guida alla destinazione',
      stays: 'Dove dormire',
      activities: 'Cosa fare',
      skiresorts: 'Comprensorio sciistico',
      dining: 'Ristoranti',
      bars: 'Bar',
      nightlife: 'Vita notturna',
    },
    entriesH2: 'Diari scritti qui',
    allEntriesLink: 'Tutti i diari',
    loading: 'Caricamento…',
    emptyH3: 'Ancora nessun diario da qui',
    emptyLead: 'Nessuno ha ancora scritto di questo posto. Se ci va, può essere la prima persona a farlo.',
    emptyCta: 'Apra il suo blog',
    stayH3: 'Trova un alloggio',
    stayNote: 'Link partner',
    stayCta: 'Sfoglia',
  },
  destinations: {
    ...
    places: {
      ...
      kemi: {
        region: 'Costa del Golfo di Botnia',
        blurb: 'Il castello di neve, le escursioni in rompighiaccio e la costa più meridionale della Lapponia. Terreno più piatto, aria salmastra, aurora sul mare.',
      },
      inari: {
        region: 'Cuore della terra sami',
        blurb: 'Il terzo lago della Finlandia. Il centro culturale sami Siida. Dove la Lapponia sembra più lontana dall’Europa.',
      },
      muonio: {
  ...
  topReads: {
    ...
    onlyLead:
      'Come si legge l’indice Kp, da dove guardare a Kemi e perché una notte di aurora è soprattutto attesa. Il pezzo che mostra la voce di Lapland.blog.',
    firstTimersEyebrow: 'Per chi parte la prima volta',
    firstTimersTitle: 'Le tre letture migliori prima di partire.',
    firstTimersSubtitle:
      'Che cosa chiede davvero luglio nello zaino, perché un’escursione estiva inizia a mezzanotte e che cosa cambia in 154 aree di sosta il prossimo inverno. Li legga e arriverà meno sorpreso.',
    ...
    foodSubtitle:
      'Zuppa di salmone al prezzo del menù, pane di segale che sopravvive a uno zaino e il caffè che si beve alle 2 del mattino perché il sole si è dimenticato di tramontare.',
  ...
  post: {
    ...
    networkCards: {
      stays: { label: 'Trova un alloggio', blurb: 'Baite, hotel, igloo di vetro e lodge' },
      activities: { label: 'Prenota un’attività', blurb: 'Safari con gli husky, motoslitte ed escursioni guidate' },
      dining: { label: 'Trova un ristorante', blurb: 'Ristoranti e cucina artica in Lapponia' },
      bars: { label: 'Bar e vita notturna', blurb: 'Bar, pub e serate in Lapponia' },
      gifts: { label: 'Attrezzatura e regali', blurb: 'Attrezzatura, abbigliamento e souvenir della Lapponia' },
      nature: { label: 'Esci nella natura', blurb: 'Sentieri, fjell e parchi nazionali' },
      kids: { label: 'In viaggio con i bambini', blurb: 'Resort per famiglie e visite a Babbo Natale' },
    },
