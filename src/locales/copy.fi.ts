...
const fi: SectionCopy = {
  ...
  newsletter: {
    ...
    successBody: 'Tarkista sähköposti, tervetuloviesti on matkalla.',
  ...
  category: {
    ...
    themes: {
      aurora: {
        ...
        description:
          'Yöt revontulten alla, rehellisesti kerrottuna. Sää, Kp-indeksi, odotus, pakkanen ja ne hetket, jotka oikeasti osuvat.',
