...
const fi: SectionCopy = {
  ...
  newsletter: {
    ...
    lead: 'Miten revontuliennustetta luetaan, milloin mökit ja retket oikeasti myydään loppuun, ja kausivinkit kirjoitettuna Suomesta. Ei roskapostia eikä täytettä. Viestimme vain kun on jotain oikeasti kerrottavaa.',
    placeholder: 'sahkoposti@esimerkki.fi',
    subscribing: 'Tilataan…',
    subscribe: 'Tilaa',
    successTitle: 'Melkein valmista.',
    successBody: 'Käy vahvistamassa tilaus sähköpostiisi tulleesta viestistä.',
    alreadyTitle: 'Olit jo listalla.',
    alreadyBody: 'Tilauksesi oli jo voimassa. Kiitos että pysyt mukana.',
  ...
  home: {
    ...
    howStep1Body:
      'Merkitse Lapin kartalle varattu mökki, ravintola ja revontulipaikka. Rakenna reitti ennen lentoa.',
    howStep2Kicker: 'Askel 02 · Kirjoita',
    howStep2Title: 'Kirjoita matkan aikana.',
    howStep2Body:
      'Puhelimella, mökissä, autossa, saunassa. Liitä kuvat, lämpötila, miltä keitto maistui. Jokainen merkintä kiinnittyy päivään ja paikkaan.',
    ...
    pillarsLead:
      'Selaa, mitä muut matkailijat ovat kirjanneet, ja valitse aiheet, joista itse kirjoitat. Revontulet, mökit, ruoka, kylmyys, ihmiset, hiljaisuus siinä välissä.',
    ...
    latestEyebrow: 'Uusimmat jutut',
    latestH2: 'Lisää kentältä.',
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Kyllä. Blogin aloittaminen, merkintöjen kirjoittaminen, kuvien lisääminen, paikkojen merkitseminen kartalle ja blogin jakaminen ovat kaikki ilmaisia. Rekisteröitymiseen ei tarvita maksukorttia, eikä blogissasi ole mainoksia.',
      },
      {
  ...
  about: {
    ...
    seedHeading: 'Kuka jutut kirjoittaa',
    seedBody:
      'Sivun jutut kirjoittaa LaplandVibesin toimitus: paikat nimeltä, hinnat ruokalistalta ja lähteet lopussa. Lukijat kirjoittavat omat matkapäiväkirjansa samalle alustalle.',
  ...
  post: {
    ...
    networkCards: {
      stays: { label: 'Etsi majoitus', blurb: 'Mökit, hotellit, lasi-iglut ja erämaahotellit' },
      activities: { label: 'Varaa elämys', blurb: 'Huskysafarit, kelkkaretket ja opastetut päivät' },
      dining: { label: 'Löydä ravintola', blurb: 'Ravintolat ja arktinen ruoka Lapissa' },
      bars: { label: 'Baarit ja yöelämä', blurb: 'Baarit, pubit ja illanvietto Lapissa' },
      gifts: { label: 'Varusteet ja lahjat', blurb: 'Retkivarusteet, vaatteet ja matkamuistot' },
      nature: { label: 'Lähde luontoon', blurb: 'Reitit, tunturit ja kansallispuistot' },
      kids: { label: 'Matkalla lasten kanssa', blurb: 'Perhekohteet ja joulupukin tapaaminen' },
    },
