...
const nl: SectionCopy = {
  ...
  home: {
    ...
    latestEyebrow: 'Nieuwste verhalen',
    latestH2: 'Meer uit het veld.',
  ...
  about: {
    ...
    seedHeading: 'Wie deze verhalen schrijft',
    seedBody:
      'De verhalen op deze site worden geschreven door de redactie van LaplandVibes: plaatsen bij naam, prijzen van de kaart gelezen, bronnen aan het eind. Lezers schrijven hun eigen reisdagboeken op hetzelfde platform.',
  ...
  post: {
    ...
    networkCards: {
      stays: { label: 'Vind een verblijf', blurb: 'Blokhutten, hotels, glazen iglo’s en lodges' },
      activities: { label: 'Boek een activiteit', blurb: 'Husky-safari’s, sneeuwscooters en begeleide tochten' },
      dining: { label: 'Vind een restaurant', blurb: 'Restaurants en arctische keuken in Lapland' },
      bars: { label: 'Bars en nachtleven', blurb: 'Bars, pubs en avonden in Lapland' },
      gifts: { label: 'Uitrusting en cadeaus', blurb: 'Uitrusting, kleding en souvenirs uit Lapland' },
      nature: { label: 'De natuur in', blurb: 'Routes, fjells en nationale parken' },
      kids: { label: 'Reizen met kinderen', blurb: 'Gezinsresorts en bezoek aan de Kerstman' },
    },
  ...
  newsletter: {
    ...
    lead: 'Hoe u de noorderlichtvoorspelling leest, wanneer hutten en tochten echt uitverkocht raken, en seizoensgebonden reisnotities geschreven vanuit Finland. Geen spam, geen opvulling. Alleen wanneer er echt iets te vertellen valt.',
