...
const ptBR: SectionCopy = {
  ...
  newsletter: {
    ...
    lead: 'Como ler a previsão de auroras, quando as cabanas e os passeios realmente esgotam, e notas de viagem sazonais escritas da Finlândia. Sem spam, sem enrolação. Só quando vale a pena contar.',
    ...
    alreadyBody: 'Parece que você já está inscrito. Obrigado por continuar com a gente.',
  ...
  home: {
    ...
    readFirstEyebrow: 'Do campo',
    readFirstH2: 'Três textos antes de fazer as malas.',
    readFirstCta: 'Todos os textos',
    readFirstRead: 'Ler',
    ...
    pillar1Body:
      'Noites de aurora, a noite polar e aquela hora azul curta ao meio-dia. Aqui o tempo é o personagem principal, não o cenário. Notas de campo sobre o que o escuro faz com uma pessoa e o que ele exige da bateria do celular.',
    pillar2Kicker: 'II · O abrigo',
    pillar2Title: 'Onde você dorme, onde você come',
    pillar2Body:
      'Cabanas de madeira, iglus de vidro, saunas que funcionam e saunas que não. Sopa de salmão pelo preço do cardápio. O pão de centeio que sobrevive a uma mochila e o café que se toma às 2 da manhã porque o sol esqueceu de se pôr.',
    ...
    latestEyebrow: 'Textos mais recentes',
    latestH2: 'Mais do campo.',
    ...
    asideP1:
      'Todo ano, milhares de visitantes chegam à Lapônia, veem algo fora do comum e perdem tudo num rolo de fotos que nunca mais abrem. A aurora sobre a cabana. A volta da sauna com os dedos dormentes. A tigela de sopa de salmão que valeu o preço. Some em uma semana.',
    asideP2:
  ...
  startHere: {
    ...
    path2Body:
      'Textos escolhidos a dedo dentro da Finlândia: o que levar para a cabana, onde tomar sopa de salmão e quanto custa, como ver a aurora em Kemi. Preços reais, horários reais, sem tom de folheto.',
    path2Cta: 'Mais lidos',
  ...
  about: {
    ...
    intro:
      'O Lapland.blog é um blog real, sem pressa e guiado pelas imagens da sua viagem, hospedado sob um nome que já recebe visitas e mantido pelo tempo que você quiser.',
    ...
    seedHeading: 'Quem escreve estes textos',
    seedBody:
      'Os textos deste site são escritos pela redação do LaplandVibes: lugares com nome, preços lidos do cardápio, fontes no fim. Os leitores escrevem seus próprios diários de viagem na mesma plataforma.',
  ...
  destination: {
    metaSuffix: 'Diários de viagem e guias de destino da rede.',
    backToAll: 'Todos os destinos',
    networkEyebrow: 'Em outros sites da rede',
    networkH2: 'Saiba mais sobre este destino',
    networkLead: 'O mesmo lugar, com mais profundidade: onde dormir, onde comer e o que fazer, cada um no seu próprio site.',
    siteLabels: {
      vibes: 'Guia do destino',
      stays: 'Onde ficar',
      activities: 'O que fazer',
      skiresorts: 'Estação de esqui',
      dining: 'Restaurantes',
      bars: 'Bares',
      nightlife: 'Vida noturna',
    },
    entriesH2: 'Diários escritos aqui',
    allEntriesLink: 'Todos os diários',
    loading: 'Carregando…',
    emptyH3: 'Ainda não há diários daqui',
    emptyLead: 'Ninguém escreveu sobre este lugar ainda. Se você vai para lá, pode ser a primeira pessoa.',
    emptyCta: 'Comece seu próprio blog',
    stayH3: 'Encontrar hospedagem',
    stayNote: 'Link de parceiro',
    stayCta: 'Ver',
  },
  destinations: {
    pageTitle: 'Destinos',
    ...
    places: {
      rovaniemi: {
        region: 'No Círculo Polar Ártico',
        blurb: 'A capital da Lapônia. Onde a maioria dos voos aterrissa. O acampamento-base para tudo que fica ao norte daqui.',
      },
      saariselka: {
        region: 'Extremo norte, região dos montes',
        blurb: 'Tundra sem árvores, iglus de vidro e o parque nacional Urho Kekkonen na porta dos fundos.',
      },
      levi: {
        region: 'Lapônia ocidental, região dos montes',
        blurb: 'A maior estação de esqui da Finlândia. Voos diretos de Helsinque no inverno. Acampamento-base para toda a família.',
      },
      kemi: {
        region: 'Costa do golfo de Bótnia',
        blurb: 'Castelo de neve, passeios de navio quebra-gelo e a costa mais ao sul da Lapônia. Terreno mais plano, ar salgado, aurora sobre o mar.',
      },
      inari: {
        region: 'Coração do território sámi',
        blurb: 'O terceiro maior lago da Finlândia. O centro cultural sámi Siida. Onde a Lapônia parece mais distante da Europa.',
      },
      muonio: {
      ...
      yllas: {
        region: 'Lapônia ocidental, região dos montes',
        blurb: 'A irmã mais tranquila de Levi. Trilhas mais largas, ritmo mais lento, o monte que tem estações próprias.',
      },
      kemijarvi: {
  ...
  topReads: {
    ...
    onlyLead:
      'Como ler o índice Kp, de onde olhar em Kemi e por que a maior parte de uma noite de aurora é espera. O texto que mostra a voz do Lapland.blog.',
    firstTimersEyebrow: 'Para iniciantes',
    firstTimersTitle: 'As três melhores para ler antes de ir.',
    firstTimersSubtitle:
      'O que julho realmente exige na mala, por que uma trilha de verão começa à meia-noite e o que muda em 154 áreas de descanso no próximo inverno. Leia e chegue menos surpreso.',
    ...
    cabinsSubtitle:
      'Como é de verdade uma cabana na floresta finlandesa: fogo, sauna, silêncio e a latrina externa no frio forte.',
    foodEyebrow: 'Comida e bebida',
    foodTitle: 'Os textos de cozinha.',
    foodSubtitle:
      'Sopa de salmão pelo preço do cardápio, pão de centeio que sobrevive a uma mochila e o café que se toma às 2 da manhã porque o sol esqueceu de se pôr.',
    seasonalEyebrow: 'De temporada',
    seasonalTitle: 'O que o frio de fato faz.',
    seasonalSubtitle:
      'O kaamos, as oito estações da Lapônia e o pequeno ofício de atravessar dezembro sem sol.',
  ...
  category: {
    ...
    themes: {
      aurora: {
        name: 'Auroras',
        tagline: 'O céu, quando colabora.',
        description:
          'Noites sob a aurora boreal, contadas com honestidade. Clima, índice Kp, espera, frio e os momentos que realmente marcam.',
        metaTitle: 'Auroras boreais na Lapônia finlandesa',
        metaDescription:
          'Noites de aurora boreal na Lapônia finlandesa, contadas com honestidade: clima, índice Kp, espera, frio e os momentos que realmente marcam.',
      },
      cabins: {
        name: 'Cabanas',
        tagline: 'Quatro paredes, um fogão a lenha, zero wi-fi.',
        description:
          'Cabanas de madeira, iglus de vidro, saunas que funcionam e saunas que não. Como é de verdade dormir longe de uma cidade.',
        metaTitle: 'Cabanas na Lapônia finlandesa',
        metaDescription:
          'Cabanas de madeira, iglus de vidro, saunas que funcionam e saunas que não. Como é de verdade dormir longe de uma cidade na Lapônia finlandesa.',
      },
      food: {
        name: 'Comida',
        tagline: 'O gosto da Lapônia no inverno.',
        description:
          'Sopa de salmão, pão de centeio, rena de três jeitos e o café que você toma às 2h da manhã porque o sol esqueceu de se pôr.',
        metaTitle: 'Comida na Lapônia finlandesa',
        metaDescription:
          'Sopa de salmão, pão de centeio, rena de três jeitos e o café das 2h da manhã porque o sol esqueceu de se pôr. Comer na Lapônia finlandesa.',
      },
      seasons: {
        name: 'Estações',
        tagline: 'Oito, não quatro.',
        description:
          'Noite polar em dezembro. Sol da meia-noite em junho. Ruska em setembro. Oito estações distintas, não quatro. Nenhuma é truque.',
        metaTitle: 'As oito estações da Lapônia finlandesa',
        metaDescription:
          'Noite polar em dezembro, sol da meia-noite em junho, ruska em setembro. A Lapônia finlandesa tem oito estações distintas, não quatro.',
      },
      people: {
        name: 'Pessoas',
        tagline: 'Quem você encontra aqui no norte.',
        description:
          'Pastores de renas, patrulheiros de pista, mestres de sauna e desconhecidos em lobbies de hotel. A Lapônia é silenciosa, mas nunca vazia.',
        metaTitle: 'As pessoas da Lapônia finlandesa',
        metaDescription:
          'Pastores de renas, patrulheiros de pista, mestres de sauna e desconhecidos em lobbies de hotel. A Lapônia é silenciosa, mas nunca vazia.',
      },
      gear: {
        name: 'Equipamento',
        tagline: 'O que sobrevive a −25 °C.',
        description:
          'Botas, luvas, camadas, baterias, escolhas de câmera. O que realmente funciona a −25 °C e o que eu joguei fora.',
        metaTitle: 'Equipamento que funciona na Lapônia finlandesa',
        metaDescription:
          'Botas, luvas, camadas, baterias e escolhas de câmera para a Lapônia finlandesa. O que realmente funciona a −25 °C e o que eu joguei fora.',
      },
      stories: {
        name: 'Histórias',
        tagline: 'O caminho mais longo.',
        description:
          'Leituras mais longas. Viagens avulsas, noites avulsas, tardes estranhas avulsas. Quando um post pede mais de 800 palavras.',
        metaTitle: 'Leituras longas da Lapônia finlandesa',
        metaDescription:
          'Leituras longas da Lapônia finlandesa: viagens avulsas, noites avulsas, tardes estranhas. Para quando um post pede mais de 800 palavras.',
      },
    },
  },
  post: {
    ...
    networkCards: {
      stays: { label: 'Encontre hospedagem', blurb: 'Cabanas, hotéis, iglus de vidro e lodges' },
      activities: { label: 'Reserve uma atividade', blurb: 'Safáris de huskies, motos de neve e passeios guiados' },
      dining: { label: 'Encontre um restaurante', blurb: 'Restaurantes e cozinha ártica na Lapônia' },
      bars: { label: 'Bares e vida noturna', blurb: 'Bares, pubs e noites na Lapônia' },
      gifts: { label: 'Equipamentos e presentes', blurb: 'Equipamentos, roupas e lembranças da Lapônia' },
      nature: { label: 'Vá para a natureza', blurb: 'Trilhas, montes e parques nacionais' },
      kids: { label: 'Viajando com crianças', blurb: 'Resorts familiares e visitas ao Papai Noel' },
    },
  ...
  signIn: {
    pageTitle: 'Planeje sua viagem à Lapônia',
    pageDescription:
