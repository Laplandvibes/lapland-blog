...
const fr: SectionCopy = {
  ...
  about: {
    ...
    seedHeading: 'Qui écrit ces textes',
    seedBody:
      'Les textes de ce site sont écrits par la rédaction de LaplandVibes : des lieux nommés, des prix lus sur la carte, des sources à la fin. Les lecteurs écrivent leurs propres carnets de voyage sur la même plateforme.',
  ...
  destinations: {
    ...
    places: {
      rovaniemi: {
        region: 'Sur le cercle polaire arctique',
      ...
      kemi: {
        region: 'Côte du golfe de Botnie',
        blurb: 'Château de neige, sorties en brise-glace et la côte la plus méridionale de Laponie. Terrain plus plat, air salin, aurores sur la mer.',
      },
      inari: {
        region: 'Cœur du pays sami',
        blurb: 'Le troisième lac de Finlande. Le centre culturel sami Siida. Là où la Laponie semble la plus éloignée de l’Europe.',
      },
      muonio: {
  ...
  post: {
    ...
    networkCards: {
      stays: { label: 'Trouver un hébergement', blurb: 'Chalets, hôtels, igloos de verre et lodges' },
      activities: { label: 'Réserver une activité', blurb: 'Safaris en traîneau à chiens, motoneige et sorties guidées' },
      dining: { label: 'Trouver une table', blurb: 'Restaurants et cuisine arctique en Laponie' },
      bars: { label: 'Bars et vie nocturne', blurb: 'Bars, pubs et soirées en Laponie' },
      gifts: { label: 'Équipement et cadeaux', blurb: 'Équipement, vêtements et souvenirs de Laponie' },
      nature: { label: 'Partir en nature', blurb: 'Sentiers, fjells et parcs nationaux' },
      kids: { label: 'Voyager avec des enfants', blurb: 'Resorts familiaux et visites au Père Noël' },
    },
    editorialLabel: 'La rédaction de LaplandVibes',
    sourcesLabel: 'Sources et méthode',
    editorialNote: 'Écrit par notre rédaction : ce n’est pas le carnet de voyage d’un lecteur.',
    readerLabel: 'Carnet de voyage d’un lecteur',
  ...
  newsletter: {
    ...
    h2: 'La Laponie dans votre boîte mail, depuis la Finlande.',
    lead: "Comment lire les prévisions d'aurores, quand les chalets et les excursions affichent vraiment complet, et des notes de voyage saisonnières écrites depuis la Finlande. Pas de spam, pas de remplissage. Seulement quand il y a vraiment quelque chose à dire.",
    placeholder: 'votre@email.com',
    subscribing: 'Inscription…',
    subscribe: "S'abonner",
    successTitle: 'Presque fini.',
    successBody: 'Confirmez votre inscription depuis l\'e-mail que nous venons de vous envoyer.',
    alreadyTitle: 'Déjà inscrit(e)',
    alreadyBody: 'Vous êtes déjà sur la liste. Merci de votre fidélité.',
