...
const de: SectionCopy = {
  ...
  newsletter: {
    ...
    lead:
      'Wie man die Polarlicht-Prognose liest, wann Hütten und Touren wirklich ausverkauft sind, und saisonale Reisenotizen aus Finnland. Kein Spam, kein Füllmaterial. Nur, wenn es wirklich der Rede wert ist.',
    ...
    alreadyBody: 'Sieht so aus, als wären Sie bereits abonniert. Danke, dass Sie dabeibleiben.',
  ...
  home: {
    ...
    pillar3Body:
      'Rentierhirten, Pistenretter, Saunameister, der Tankwart bei Sodankylä, der vier Sprachen sprach. Lappland ist still, aber nie leer. Längere Stücke über die Menschen, denen man wirklich begegnet.',
    latestEyebrow: 'Neueste Texte',
    latestH2: 'Mehr aus dem Feld.',
  ...
  startHere: {
    ...
    path1Title: 'Ich plane eine Reise nach Lappland.',
    path1Body:
    ...
    planStay: {
      ...
      body: 'Hunderte Lappland-Unterkünfte vergleichen: Glasiglus, Holzhütten, Skiresorts.',
    },
    planTransport: {
      kicker: 'Hinkommen',
  ...
  about: {
    ...
    seedHeading: 'Wer die Texte schreibt',
    seedBody:
      'Die Texte auf dieser Seite schreibt die LaplandVibes-Redaktion: Orte beim Namen, Preise von der Karte gelesen, Quellen am Ende. Leserinnen und Leser schreiben ihre eigenen Reisetagebücher auf derselben Plattform.',
  ...
  destinations: {
    ...
    lead:
      'Wählen Sie ein Ziel und lesen Sie die Einträge von dort. Wo noch nichts steht, ist der nächste Eintrag frei: Sie können der oder die Erste sein.',
    ...
    places: {
      ...
      levi: {
        ...
        blurb: 'Finnlands größtes Skizentrum. Im Winter Direktflüge aus Helsinki. Familienfreundliches Basislager.',
      },
      kemi: {
      ...
      muonio: {
        ...
        blurb: 'Am Rand des Pallas-Yllästunturi-Nationalparks. Hier zählen die Nordlicht-Sichtbarkeitswerte zu den höchsten Europas.',
      },
      yllas: {
        region: 'West-Lappland, Fjelllandschaft',
  ...
  post: {
    ...
    networkCards: {
      stays: { label: 'Unterkunft finden', blurb: 'Hütten, Hotels, Glas-Iglus und Lodges' },
      activities: { label: 'Aktivität buchen', blurb: 'Husky-Safaris, Schneemobile und geführte Touren' },
      dining: { label: 'Restaurant finden', blurb: 'Restaurants und arktische Küche in Lappland' },
      bars: { label: 'Bars und Nachtleben', blurb: 'Bars, Pubs und lange Abende in Lappland' },
      gifts: { label: 'Ausrüstung und Geschenke', blurb: 'Ausrüstung, Kleidung und Souvenirs aus Lappland' },
      nature: { label: 'Raus in die Natur', blurb: 'Wege, Fjells und Nationalparks' },
      kids: { label: 'Mit Kindern unterwegs', blurb: 'Familienresorts und Besuche beim Weihnachtsmann' },
    },
  ...
  signIn: {
    ...
    benefit3Title: 'Mit einem Fingertipp auf Instagram teilen',
  ...
  unsubscribe: {
    ...
    lead: 'Geben Sie die abonnierte E-Mail ein. Ein Klick, und Sie sind abgemeldet. Keine „Sind Sie sicher?“-Schleifen, keine Umfrage.',
