...
const de: SectionCopy = {
  ...
  newsletter: {
    ...
    lead:
      'Wie man die Polarlicht-Prognose liest, wann Hütten und Touren wirklich ausverkauft sind, und saisonale Reisenotizen aus Finnland. Kein Spam, keine Füllung. Nur, wenn es wirklich der Rede wert ist.',
    placeholder: 'ihre@email.de',
    subscribing: 'Wird abonniert…',
    subscribe: 'Abonnieren',
    successTitle: 'Sie sind dabei.',
    successBody: 'Prüfen Sie Ihr Postfach. Eine Willkommens-E-Mail ist unterwegs.',
  ...
  category: {
    ...
    themes: {
      ...
      cabins: {
        ...
        metaDescription:
          'Holzhütten, Glasiglus, Saunen, die funktionieren, und solche, die es nicht tun. Wie es wirklich ist, in Finnisch-Lappland weit weg von einer Stadt zu schlafen.',
      },
      food: {
        name: 'Essen',
        tagline: 'Wonach Lappland im Winter schmeckt.',
        description:
          'Lachssuppe, Roggenbrot, Rentier auf drei Arten und der Kaffee, den du um 2 Uhr nachts trinkst, weil die Sonne vergessen hat unterzugehen.',
