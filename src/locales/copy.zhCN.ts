...
const zhCN: SectionCopy = {
  ...
  home: {
    ...
    seasonalH2: '为您的拉普兰之旅打造的免费旅行博客，边走边写。',
    seasonalLead:
    ...
    pillar1Body:
      '极光之夜、极地的黑暗，以及大多数清单都遗忘的八个季节。在这里，天气是主角，而非背景。实地笔记记下凌晨 03:47 的零下二十三度是什么感觉，以及它会把一块手机电池、把一个人折腾成什么样。',
    pillar2Kicker: 'II · 栖身',
    pillar2Title: '您睡在哪里，吃在哪里',
    pillar2Body:
      '木屋、玻璃冰屋，管用的桑拿和不管用的桑拿。那碗 42 欧元、最后证明物有所值的三文鱼汤。能在背包里挺过来的黑麦面包，以及您在凌晨两点喝下的咖啡，因为太阳忘了落下。',
    ...
    faq: [
      {
        ...
        a: '用您的 Google 账号登录，为博客取个名字，然后写下第一篇记录。每篇记录都可以包含文字、照片、日期，以及标记您所在位置的地图图钉。您的博客地址为 lapland.blog/by/your-name，发布即可分享，无需安装任何东西，除了登录之外也没有其他设置。',
      },
      {
        q: 'lapland.blog 免费吗？',
  ...
  about: {
    ...
    howStepShare: '你的记录会成为 lapland.blog/by/your-name 上的公开博客。朋友可以关注，每篇还能导出为 Instagram 快拍。',
    howBody:
    ...
    freeHeading: '哪些是免费的',
    freeBody:
      '撰写文章。在 lapland.blog/by/your-name 托管您的旅行博客。照片。新闻通讯。在写作者这一端，没有付费墙，也没有高级套餐。',
    notHeading: '您不会遇到的',
    notBody:
  ...
  signIn: {
    ...
    h1Italic: '拉普兰之旅。',
    lead:
      '在 lapland.blog/by/your-name 获得专属页面，撰写您的旅程故事、分享照片，并获得为您行程量身定制的建议与优惠。告诉我们您何时到访，我们会帮您规划每一步。',
