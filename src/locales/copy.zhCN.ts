...
const zhCN: SectionCopy = {
  ...
  home: {
    ...
    howStep3Body:
      '您的文章会汇成一个公开博客，网址是 lapland.blog/by/your-name。朋友们可以关注。每篇还能导出成 Instagram 快拍，让旅程活上两次。',
    howCta: '创建您的旅行博客',
    ...
    pillar2Body:
      '木屋、玻璃冰屋，管用的桑拿和不管用的桑拿。那碗四十二欧元、最后证明值得的三文鱼汤。能在背包里挺过来的黑麦面包，以及您在凌晨两点喝下的咖啡，因为太阳忘了落下。',
  ...
  category: {
    ...
    themes: {
      ...
      people: {
        ...
        metaTitle: '芬兰拉普兰的人 · Lapland.blog',
        metaDescription:
          '驯鹿牧民、滑雪巡逻员、桑拿师傅，还有酒店大堂里的陌生人。拉普兰安静，却从不空旷。',
      },
      gear: {
