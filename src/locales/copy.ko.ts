...
const ko: SectionCopy = {
  ...
  home: {
    ...
    seasonalLead:
      'Lapland.blog는 여행을 간결하고 아름다운 블로그로 만들어 줍니다. 장소에 핀을 꽂고, 사진을 더하고, 있었던 일을 적은 뒤 링크를 친구들과 공유하세요. 지금은 여름입니다. 해가 지지 않는 서른두 밤, 숲은 호박빛으로 물들고 호수는 하늘을 비춥니다. 아직 그 안에 머물러 있을 때 여행기를 시작하세요.',
    ...
    seasonalCard3Body: '자정, 14도의 호수. 다섯 걸음 옆에는 90도 사우나. 그리고 반복.',
  ...
  about: {
    ...
    seedHeading: '시드 글',
    seedBody:
      '사이트에 올라와 있는 글은 Lapland.blog의 편집부인 The Field Journal이 작성합니다. 계절, 트레일, 음식, 통나무집, 장비: 저마다 자기 분야를 맡은 다섯 명의 이름 있는 편집 필자들입니다. 솔직하고 천천히 흘러가며 사진을 중심으로 한 여행 블로그가 어떻게 읽힐 수 있는지를 보여 드리기 위해 마련된 것입니다. 진짜 기온, 진짜 시각, 안내 책자식 어투 없음. 한 편 읽어 보시고 여러분의 여행을 떠올려 보세요.',
  ...
  signIn: {
    ...
    h1Italic: '라플란드 여행.',
    lead:
      'lapland.blog/by/your-name에서 본인의 페이지를 받으세요. 여행 이야기를 쓰고, 사진을 공유하고, 여정에 맞춘 팁과 혜택을 받으세요. 언제 오시는지 알려 주시면 모든 단계를 도와 드립니다.',
