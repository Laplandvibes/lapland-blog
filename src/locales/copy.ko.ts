...
const ko: SectionCopy = {
  ...
  about: {
    ...
    intro:
      'Lapland.blog는 이미 트래픽이 있는 도메인 아래에서 진짜로, 천천히, 사진을 중심으로 쓰는 여행 블로그입니다. 원하시는 만큼 오래 보관됩니다.',
    howHeading: '사용 방법',
  ...
  topReads: {
    ...
    cabinsSubtitle:
      '핀란드 숲속 오두막이 실제로 어떤지: 불, 사우나, 고요함, 그리고 강추위 속 바깥 화장실.',
    foodEyebrow: '식음료',
    foodTitle: '주방 글.',
    foodSubtitle:
    ...
    seasonalSubtitle:
      '카모스(극야), 라플란드의 여덟 계절, 그리고 태양 없이 12월을 통과하는 작은 일.',
