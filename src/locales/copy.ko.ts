...
const ko: SectionCopy = {
  ...
  home: {
    ...
    howStep3Body:
      '여러분의 글은 lapland.blog/by/your-name의 공개 블로그가 됩니다. 친구들이 따라 읽을 수 있고, 각 글은 Instagram 스토리로 내보낼 수 있습니다. 여행은 두 번 살아납니다.',
    howCta: '여행 블로그 시작하기',
    ...
    liveLead:
      '레비의 최상급 코스. 이나리의 오로라 밤. 사리셀카에서 허스키 썰매로 60km. 이 예시 블로그들은 저희 편집부인 The Field Journal이 형식을 보여 드리기 위해 만든 것입니다. 여러분의 진짜 블로그는 시작하는 데 5분도 걸리지 않습니다.',
    ...
    featuredEvery: '모든 글 →',
    featuredLead:
      '여러분의 여행 블로그가 어떤 모습일 수 있는지 보여 드리는 예시입니다. 아래 글은 Lapland.blog의 편집부인 The Field Journal이 쓴 것으로, 백야부터 극야까지 라플란드의 한 해를 담아내는 작은 필진입니다. 진짜 기온, 진짜 통나무집, 진짜 수프. 한 편 읽어 보시고 여러분의 여행을 떠올려 보십시오.',
    ...
    pillarsLead:
      '다른 여행자들이 남긴 글들을 둘러보시고, 여러분 자신의 여행에서 다룰 갈래를 고르십시오. 오로라, 통나무집, 음식, 추위, 사람들, 그리고 그 사이에 있는 정적.',
    pillar1Kicker: 'I · 추위',
    ...
    pillar2Body:
      '나무로 지은 통나무집, 유리 이글루, 잘 작동하는 사우나와 그렇지 않은 사우나. 결국 그 값을 한 42유로짜리 연어 수프. 배낭 안에서도 살아남는 호밀빵, 그리고 해가 지는 일을 잊었기에 새벽 두 시에 마시는 커피.',
    ...
    asideH2: '라플란드는 안내 책자가 아닙니다. 여러분의 여행도 그래서는 안 됩니다.',
    asideP1:
