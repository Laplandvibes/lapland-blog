...
const ko: SectionCopy = {
  ...
  home: {
    ...
    heroLead:
      '오로라를 본 자리에 핀을 꽂으십시오. 통나무집을 사진에 담으십시오. 기온이 어땠는지 기록하십시오. 친구들이 실제로 따라 읽을 수 있는 아름다운 여행 블로그를 만드십시오.',
    ...
    seasonalLead:
      'Lapland.blog는 여행을 간결하고 아름다운 블로그로 만들어 줍니다. 장소에 핀을 꽂고, 사진을 더하고, 있었던 일을 적은 뒤 링크를 친구들과 공유하십시오. 지금은 여름입니다. 해가 지지 않는 서른두 밤, 숲은 호박빛으로 물들고 호수는 하늘을 비춥니다. 아직 그 안에 머물러 있을 때 여행기를 시작하십시오.',
    ...
    seasonalCard4Body: '겨울에 만실이 되는 통나무집들이 7월에는 비어 있습니다. 같은 숲, 기다림은 없음.',
    ...
    howStep1Body:
      '예약한 통나무집, 가 보고 싶은 식당, 오로라를 보러 갈 캄캄한 밤하늘 명소를 라플란드 지도 위에 핀으로 표시하세요. 떠나기 전에 경로를 짜십시오.',
    howStep2Kicker: '02단계 · 기록',
    howStep2Title: '여행하면서 쓰십시오.',
    howStep2Body:
      '휴대전화로, 통나무집에서, 차 안에서, 사우나에서. 사진과 기온, 수프의 맛을 더하십시오. 각 글에는 그날의 날짜와 장소가 자동으로 표시됩니다.',
    howStep3Kicker: '03단계 · 공유',
    howStep3Title: '잘 쓰인 여러분의 여행.',
    howStep3Body:
      '여러분의 글은 lapland.blog/by/your-name의 공개 블로그가 됩니다. 친구들이 따라 읽을 수 있고, 각 글은 Instagram 스토리로 내보낼 수 있습니다. 여행을 두 번 경험하게 됩니다.',
    howCta: '여행 블로그 시작하기',
    howFootnote: '여행기는 무료 · 카드 불필요 · Google로 로그인',
    liveEyebrow: '편집부의 예시 블로그',
    liveH2Pre: '여행 블로그란',
    liveH2Italic: '이런 모습입니다.',
    liveH2Tail: '다음은 여러분의 차례입니다.',
    liveLead:
      '레비의 최상급자 코스. 이나리의 오로라 밤. 사리셀카에서 허스키 썰매로 60km. 이 예시 블로그들은 저희 편집부인 The Field Journal이 형식을 보여 드리기 위해 만든 것입니다. 여러분의 진짜 블로그는 시작하는 데 5분도 걸리지 않습니다.',
    ...
    featuredEvery: '모든 글 →',
    featuredLead:
      '여러분의 여행 블로그가 어떤 모습일 수 있는지 보여 드리는 예시입니다. 아래 글은 Lapland.blog의 편집부인 The Field Journal이 쓴 것입니다. 백야부터 극야까지 라플란드의 한 해를 담아내는 작은 필진입니다. 진짜 기온, 진짜 통나무집, 진짜 수프. 한 편 읽어 보시고 여러분의 여행을 떠올려 보십시오.',
    ...
    pillar2Body:
      '통나무집, 글래스 이글루, 잘 작동하는 사우나와 그렇지 않은 사우나. 결국 그 값을 한 42유로짜리 연어 수프. 배낭 안에서도 살아남는 호밀빵, 그리고 해가 지는 일을 잊었기에 새벽 두 시에 마시는 커피.',
    ...
    asideP2:
      'Lapland.blog는 이를 바로잡기 위한 작은 무료 도구입니다. 어디 있었는지 핀을 꽂으십시오. 무엇을 보았는지 쓰십시오. 수프를 사진에 담으십시오. 귀국할 즈음이면 진짜 여행 블로그가 손에 있게 됩니다. 친구들이 실제로 따라 읽을 수 있고, 5년 뒤에도 다시 읽고 싶어지는 블로그입니다. 스톡 사진도, "환상의 겨울 왕국"도 없습니다. 오직 그곳에 대한 여러분의 솔직한 기록만이 남습니다.',
    ...
    faq: [
      {
        ...
        a: 'Google 계정으로 로그인하고 블로그 이름을 정한 뒤 첫 글을 쓰면 됩니다. 각 글에는 텍스트, 사진, 날짜, 그리고 머문 장소를 표시하는 지도 핀을 담을 수 있습니다. 블로그는 lapland.blog/by/your-name 주소에 만들어지며 게시하는 즉시 공유할 수 있습니다. 설치할 것도 없고 로그인 외에 따로 설정할 것도 없습니다.',
      },
      {
  ...
  startHere: {
    ...
    lead:
      'Lapland.blog는 실제로 라플란드를 찾는 분들을 위한, 무료이며 천천히 흘러가고 사진을 중심으로 한 여행 일기 사이트입니다. 여행을 계획 중이시든, 여행 도중이시든, 귀국 후에 그때 적어 둘 걸 하고 후회하시든, 자신에게 맞는 입구를 고르십시오.',
    path1Kicker: '01 · 계획',
    ...
    planStay: {
      kicker: '숙박',
      title: '통나무집, 이글루, 호텔',
      body: '유리 이글루, 통나무집, 스키 리조트 등 라플란드 숙소 수백 곳을 비교하십시오.',
    },
    planTransport: {
      kicker: '이동',
      title: '항공편, 기차, 버스',
  ...
  about: {
    ...
    pageDescription:
      'Lapland.blog는 라플란드를 찾는 분들을 위한 무료 여행 일기 플랫폼입니다. 장소에 핀을 꽂고, 글을 쓰고, 친구들과 공유하십시오. 잘 쓰인 여러분의 여행입니다.',
    eyebrow: '플랫폼 소개',
    h1: '간직할 만한 여행 일기.',
    lead:
      'Lapland.blog는 라플란드를 찾는 분들을 위한 무료 여행 일기 플랫폼입니다. 오로라를 본 자리에 핀을 꽂으십시오. 통나무집을 사진에 담으십시오. 기온이 어땠는지 기록하십시오. 귀국할 즈음이면 친구들이 실제로 따라 읽을 수 있고 5년 뒤에도 다시 읽고 싶어질 여행 블로그가 손에 들어옵니다.',
    intro:
    ...
    howHeading: '사용 방법',
    howStepPin: '머물 통나무집, 가고 싶은 식당, 빛 없는 하늘 명소에 핀을 꽂으십시오. 떠나기 전에 동선을 짭니다.',
    howStepWrite: '여행하면서 씁니다. 통나무집에서, 차 안에서, 사우나에서. 사진과 기온, 수프의 맛을 더하십시오.',
    howStepShare: '글은 lapland.blog/by/your-name의 공개 블로그가 됩니다. 친구들이 팔로우할 수 있고, 각 글은 인스타그램 스토리로 내보낼 수 있습니다.',
    howBody:
      '이메일이나 Google로 로그인하십시오. lapland.blog/me에서 나만의 공간을 만드십시오. 각 글은 대표 이미지, 장소 핀, 그리고 하고 싶은 말로 구성됩니다. 초안을 저장하고, 준비가 되면 공개하고, 친구들에게 링크를 공유하십시오. 공개된 모든 글은 색인되어 검색에 노출되며, 여러분의 여행은 더 큰 라플란드 아카이브의 한 조각이 됩니다.',
    freeHeading: '무엇이 무료인가',
    freeBody:
      '글 작성, lapland.blog/by/your-name 아래의 여행 블로그 호스팅, 사진, 뉴스레터. 작성자 측에는 유료 장벽도 프리미엄 등급도 없습니다.',
    ...
    seedHeading: '시드 글',
    seedBody:
      '사이트에 올라와 있는 글은 Lapland.blog의 편집부인 The Field Journal이 작성합니다. 계절, 트레일, 음식, 통나무집, 장비: 저마다 자기 분야를 맡은 다섯 명의 이름 있는 편집 필자들입니다. 솔직하고 천천히 흘러가며 사진을 중심으로 한 여행 블로그가 어떻게 읽힐 수 있는지를 보여 드리기 위해 마련된 것입니다. 진짜 기온, 진짜 시각, 안내 책자식 어투 없음. 한 편 읽어 보시고 여러분의 여행을 떠올려 보십시오.',
    ...
    contactHeading: '문의',
    contactBody:
      '인사를 전하거나, 사실 오류를 바로잡거나, 출처를 밝힐 수 있는 사진을 보내 주시려면 info@laplandvibes.com으로 메일을 보내 주십시오. 모두 읽고 일주일 안에 답해 드리려 합니다.',
  ...
  destinations: {
    ...
    pageDescription:
      '라플란드의 주요 여덟 곳: 로바니에미, 사리셀카, 레비, 케미, 이나리, 무오니오, 윌래스, 케미야르비. 각 지역의 현장 일기를 읽거나, 최초의 글을 작성하십시오.',
    eyebrow: '어디로 갈까',
    h1Pre: '여덟 곳.',
    h1Italic: '하나의 라플란드.',
    lead:
  ...
  signIn: {
    ...
    h1Italic: '라플란드 여행.',
    lead:
      'lapland.blog/by/your-name에서 본인의 페이지를 받으십시오. 여행 이야기를 쓰고, 사진을 공유하고, 여정에 맞춘 팁과 혜택을 받으십시오. 언제 오시는지 알려 주시면 모든 단계를 도와 드립니다.',
