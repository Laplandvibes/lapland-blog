...
const en: SectionCopy = {
  ...
  newsletter: {
    ...
    lead: 'How to read the aurora forecast, when cabins and tours really sell out, and seasonal travel notes written from Finland. No spam, no filler. Only when something is worth flagging.',
    ...
    alreadyBody: "Looks like you're already subscribed. Thanks for sticking with us.",
  ...
  about: {
    ...
    seedHeading: 'Who writes these',
    seedBody:
      'The stories on this site are written by the LaplandVibes editorial desk: places named, prices read off the menu, sources at the end. Readers write their own trip diaries on the same platform.',
  ...
  post: {
    ...
    networkCards: {
      stays: { label: 'Find places to stay', blurb: 'Cabins, hotels, glass igloos and lodges' },
      activities: { label: 'Book an activity', blurb: 'Husky safaris, snowmobiles and guided days out' },
      dining: { label: 'Find a table', blurb: 'Restaurants and Arctic dining in Lapland' },
      bars: { label: 'Bars and nightlife', blurb: 'Bars, pubs and late evenings in Lapland' },
      gifts: { label: 'Gear and gifts', blurb: 'Equipment, clothing and Lapland souvenirs' },
      nature: { label: 'Head outdoors', blurb: 'Trails, fells and national parks' },
      kids: { label: 'Travelling with children', blurb: 'Family resorts and Santa Claus visits' },
    },
