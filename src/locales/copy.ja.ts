...
const ja: SectionCopy = {
  ...
  newsletter: {
    ...
    lead: 'オーロラ予報の読み方、コテージやツアーが実際に売り切れる時期、そしてフィンランド現地から綴る季節ごとの旅メモ。広告も水増しもなし。お届けするのは本当に価値のあるときだけです。',
    ...
    alreadyBody: 'すでにご登録いただいているようです。引き続きよろしくお願いします。',
  ...
  home: {
    ...
    heroLead:
      'オーロラを見た場所にピンを立てる。コテージを撮影する。気温を書き留める。友人がちゃんとフォローできる、美しい旅行ブログを作りましょう。',
    heroPrimaryCta: '旅行ブログを始める',
    heroSecondaryCta: '使い方を見る',
    heroFootnote: 'あなたの旅行記は無料で使えます · フィンランド発 · Instagramにシェア',
    seasonalBadge: 'いまが季節 · 白夜 · 6月6日 → 7月7日',
    seasonalH2: 'ラップランド旅行の無料ブログ。旅しながら書けます。',
    seasonalLead:
      'Lapland.blog なら、旅がそのままシンプルで美しいブログに。場所にピンを立て、写真を加え、起きたことを書き、リンクを友人に送るだけ。いまの季節は夏。太陽が沈まない32夜、森は琥珀色に染まり、湖は空を映します。旅の最中から、旅行記を始めましょう。',
    ...
    seasonalCard3Body: '真夜中の14°Cの湖、5歩先には90°Cのサウナ。繰り返す。',
    seasonalCard4Title: '誰もいない',
    seasonalCard4Body: '冬には満室になるコテージが、7月には空いている。同じ森、行列なし。',
    ...
    howStep2Body:
      'スマートフォンから、コテージで、車内で、サウナで。写真、気温、スープの味を加える。各記事は自動的にその日と場所にピン留めされます。',
    howStep3Kicker: 'ステップ03 · シェア',
    howStep3Title: 'よく語られた、あなたの旅。',
    howStep3Body:
      'エントリーは lapland.blog/by/あなたの名前 の公開ブログになります。友人がフォローでき、各投稿はInstagramのストーリーに書き出せます。旅を二度味わえます。',
    howCta: '旅行ブログを始める',
    ...
    pillar1Body:
      'オーロラの夜、極夜、多くのガイドが見落とす八つの季節。ここでは天気が主役で、背景ではありません。午前3時47分のマイナス23度がどう感じられるか、スマートフォンのバッテリーや人の体にどう影響するかを記したフィールドノート。',
    pillar2Kicker: 'II · 宿と食',
    pillar2Title: '眠る場所、食べる場所',
    pillar2Body:
      '木造のコテージ、グラスイグルー、機能するサウナと機能しないサウナ。結果的に価値のあった42ユーロのサーモンスープ。バックパックの中でも生き残るライ麦パンと、太陽が沈み忘れたから午前2時に飲むコーヒー。',
    pillar3Kicker: 'III · 出会う人々',
    pillar3Title: 'ここに住むほかの人々',
    pillar3Body:
      'トナカイ飼育者、スキーパトロール、サウナの達人、ソダンキュラ郊外のガソリンスタンドで四ヶ国語を話した男性。ラップランドは静かですが、決して無人ではありません。実際に出会う人々についての長文記事。',
    latestEyebrow: 'サンプル記事',
    latestH2: '旅行ブログのかたちを見る。',
    latestEvery: 'すべての記事',
    latestLoading: '記事を読み込み中…',
    asideEyebrow: 'なぜこのサイトがあるのか',
    asideH2: 'ラップランドはパンフレットではありません。あなたの旅も、そうであるべきではありません。',
    asideP1:
      '毎年、数千人の旅行者がラップランドを訪れ、何か特別なものを目にし、二度と開かないカメラロールの中に眠らせてしまいます。コテージの上のオーロラ。サウナから戻る指先が痺れる道。なぜか42ユーロの価値があったサーモンスープ。一週間で消えていきます。',
    asideP2:
      'Lapland.blogは、それを変えるための小さな無料ツールです。どこにいたかをピン留めし、何を見たかを書き、スープを撮影する。帰国するころには、本物の旅行ブログが手元にあります。友人が実際にフォローでき、5年後にも読み返したくなるものです。ストック写真はなく、「魔法のような冬の世界」もなく、あるのは、あなた自身の飾らない記録だけです。',
    ...
    faq: [
      {
        ...
        a: 'Googleアカウントでサインインし、ブログに名前を付けて、最初の記事を書くだけです。各記事にはテキスト、写真、日付、そして滞在した場所の地図ピンを添えられます。ブログは lapland.blog/by/あなたの名前 に公開され、投稿した瞬間に共有できます。インストールは不要で、サインイン以外の設定もありません。',
      },
      {
        q: 'lapland.blog は無料ですか？',
        a: 'lapland.blog は無料ですか？、ブログの共有はすべて無料です。登録にクレジットカードは不要で、あなたのブログに広告は表示されません。',
      },
      {
      ...
      },
      {
        ...
        a: 'いいえ。lapland.blog はフィンランド・ラップランドへ向かう旅行者のために作られており、地図や執筆のヒントは北の旅に合わせて作られています。ただし、旅を計画中の方も、旅の最中の方も、帰宅後にまとめる方も、どなたでもブログを持てます。出発前に始めて、一日ずつ記事を追加していくこともできます。',
      },
      {
        q: 'ラップランドの旅日記には何を書けばいいですか？',
        a: '忘れたくないことを何でも。泊まった場所、オーロラの様子、一番寒い朝の気温、思いがけずおいしかった食事、ハスキー体験、森の静けさ。写真と地図ピンを添えた短い記事がおすすめです。1日数行でも、読み返したくなるブログに育っていきます。',
      },
    ],
  },
  startHere: {
    ...
    planStay: {
      kicker: '泊まる',
      title: 'コテージ、イグルー、ホテル',
      body: 'ラップランドの宿泊先を数百件比較：グラスイグルー、ログコテージ、スキーリゾート。',
    },
    planTransport: {
      kicker: '行く',
      title: 'フライト、鉄道、バス',
  ...
  about: {
    ...
    howStepShare: '記事は lapland.blog/by/あなたの名前 で公開ブログに。友人がフォローでき、各記事はInstagramストーリーに書き出せます。',
    howBody:
    ...
    freeBody:
      '記事の作成、lapland.blog/by/あなたの名前 配下での旅行ブログのホスティング、写真、ニュースレター。執筆側にペイウォールも有料プランもありません。',
    notHeading: '見つからないもの',
    notBody:
    ...
    contactBody:
      '挨拶、事実誤認の指摘、クレジット付きで掲載できる写真の送付などは info@laplandvibes.com までメールでお寄せください。すべて読み、一週間以内の返信を心がけています。',
  ...
  destinations: {
    ...
    places: {
      ...
      saariselka: {
        ...
        blurb: '木のないツンドラ、グラスイグルー、そして裏口の先にはウルホ・ケッコネン国立公園。',
      },
      levi: {
        region: '西ラップランド、丘陵地帯',
      ...
      muonio: {
        ...
        blurb: 'パラス・ユッラストゥントゥリ国立公園の縁。オーロラの観測条件はヨーロッパでも指折り。',
      },
      yllas: {
        region: '西ラップランド、丘陵地帯',
  ...
  signIn: {
    ...
    h1Italic: 'ラップランドの旅。',
    lead:
      'lapland.blog/by/あなたの名前 であなただけのページを取得。旅の物語を書き、写真を共有し、行程に合わせたおすすめとお得情報を受け取れます。いつ訪れるかをお知らせいただければ、すべてのステップをお手伝いします。',
