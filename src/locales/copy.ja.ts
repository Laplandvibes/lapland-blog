...
const ja: SectionCopy = {
  ...
  home: {
    ...
    howStep3Body:
      'エントリーは lapland.blog/by/your-name の公開ブログになります。友人がフォローでき、各投稿はInstagramのストーリーに書き出せます。旅は二度生きます。',
    howCta: '旅行ブログを始める',
    ...
    faq: [
      {
        ...
        a: 'Googleアカウントでサインインし、ブログに名前を付けて、最初の記事を書くだけです。各記事にはテキスト、写真、日付、そして滞在した場所の地図ピンを添えられます。ブログは lapland.blog/by/your-name に公開され、投稿した瞬間に共有できます。インストールは不要で、サインイン以外の設定もありません。',
      },
      {
  ...
  about: {
    ...
    howStepShare: '記事は lapland.blog/by/your-name で公開ブログに。友人がフォローでき、各記事はInstagramストーリーに書き出せます。',
    howBody:
    ...
    freeBody:
      '記事の作成、lapland.blog/by/your-name 配下での旅行ブログのホスティング、写真、ニュースレター。執筆側にペイウォールも有料プランもありません。',
    notHeading: '見つからないもの',
    notBody:
  ...
  signIn: {
    ...
    h1Italic: 'ラップランドの旅。',
    lead:
      'lapland.blog/by/your-name であなただけのページを取得。旅の物語を書き、写真を共有し、行程に合わせたおすすめとお得情報を受け取れます。いつ訪れるかをお知らせいただければ、すべてのステップをお手伝いします。',
