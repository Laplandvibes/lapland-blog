...
const ja: SectionCopy = {
  ...
  home: {
    ...
    featuredLead:
      'これは、あなた自身の旅行ブログがどのようになり得るかの一例です。以下の記事は、Lapland.blogの編集部「LaplandVibes」によるもの。白夜から極夜まで、ラップランドの一年を書きつづる小さな執筆陣です。本物の気温、本物のコテージ、本物のスープ。一つ読んで、自分の旅を思い描いてください。',
  ...
  about: {
    ...
    seedBody:
      'サイトにすでにある記事は、Lapland.blogの編集部であるLaplandVibesが書いています。正直で、ゆっくりとした、写真中心の旅行ブログがどう読めるのかを示すためのものです。場所は名前で、値段はメニューから、出典は最後に。一本読んで、ご自身のブログを思い描いてみてください。',
  ...
  post: {
    ...
    editorialLabel: 'LaplandVibesの記事',
    editorialNote: 'Lapland.blogの編集部であるLaplandVibesが書いた記事のひとつ。正直な旅日記がどう読めるかを示すためのものです。実在の場所、実際の値段。あなたの記事はあなたが書きます。',
  },
  signIn: {
