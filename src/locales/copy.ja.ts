...
const ja: SectionCopy = {
  ...
  about: {
    ...
    intro:
      'Lapland.blogは、本物で、ゆっくりとした、写真を中心にした旅行ブログです。すでにアクセスのあるドメイン上で、お望みの期間だけ保管します。',
    howHeading: '使い方',
  ...
  topReads: {
    ...
    cabinsSubtitle:
      'フィンランドの森のコテージが実際どんなものか。火、サウナ、静けさ、そして厳しい寒さの中の外トイレ。',
    foodEyebrow: '食事と飲み物',
    foodTitle: 'キッチンの記事。',
    foodSubtitle:
    ...
    seasonalSubtitle:
      'カーモス（極夜）、ラップランドの八つの季節、太陽のない12月を乗り切るというささやかな営み。',
    ctaEyebrow: '次はあなたの旅？',
    ctaH2: 'このページの次の記事になる。',
    ctaLead:
