...
const ja: SectionCopy = {
  ...
  home: {
    ...
    readFirstEyebrow: '現場から',
    readFirstH2: '荷造りの前に読む三本。',
    readFirstCta: 'すべての記事',
    readFirstRead: '読む',
    howEyebrow: '使い方',
    ...
    pillar1Body:
      'オーロラの夜、極夜、そして正午の短い青い時間。ここでは天気が背景ではなく主役です。暗さが人に何をするのか、そして携帯のバッテリーに何を求めるのかについての現場メモ。',
    pillar2Kicker: 'II · 宿と食',
    pillar2Title: '眠る場所、食べる場所',
    pillar2Body:
      '木のコテージ、ガラスのイグルー、うまくいくサウナとそうでないサウナ。メニューに書かれた値段のサーモンスープ。バックパックでも潰れないライ麦パンと、太陽が沈み忘れた夜中の2時に飲むコーヒー。',
    ...
    asideP1:
      '毎年、何千人もの旅行者がラップランドを訪れ、並外れたものを目にし、そして二度と開かない写真フォルダの中にそれを失います。コテージの上のオーロラ。指がかじかんだサウナからの帰り道。値段だけの価値があったサーモンスープ。一週間で消えてしまいます。',
    asideP2:
  ...
  about: {
    ...
    seedHeading: '記事を書いているのは',
    seedBody:
      'このサイトの記事はLaplandVibes編集部が書いています。場所は名前で、値段はメニューから、出典は最後に。読者は同じ場所で自分の旅日記を書きます。',
  ...
  topReads: {
    ...
    onlyH2: '編集者の一押し。',
    onlyLead:
      'Kp指数の読み方、ケミではどこから見るか、そしてオーロラの夜のほとんどが待ち時間である理由。Lapland.blogの声がわかる一本です。',
    firstTimersEyebrow: '初めての方へ',
    firstTimersTitle: '旅立つ前に読みたい三篇。',
    firstTimersSubtitle:
      '7月に本当に必要な持ち物、夏のハイキングが真夜中に始まる理由、そして来冬に154か所の休憩所で変わること。読んでおけば、驚きは少なくなります。',
    ...
    cabinsSubtitle:
      'フィンランドの森のコテージが実際どんなものか。火、サウナ、静けさ、そして厳しい寒さの中の外トイレについて誰も言わないこと。',
    foodEyebrow: '食事と飲み物',
    foodTitle: 'キッチンの記事。',
    foodSubtitle:
      'メニューの値段のサーモンスープ、バックパックでも潰れないライ麦パン、そして太陽が沈み忘れた夜中の2時に飲むコーヒー。',
    seasonalEyebrow: '季節',
  ...
  post: {
    ...
    networkCards: {
      stays: { label: '宿を探す', blurb: 'コテージ、ホテル、グラスイグルー、ロッジ' },
      activities: { label: 'アクティビティを予約', blurb: 'ハスキーサファリ、スノーモービル、ガイドツアー' },
      dining: { label: 'レストランを探す', blurb: 'ラップランドのレストランと北極圏の料理' },
      bars: { label: 'バーとナイトライフ', blurb: 'ラップランドのバー、パブ、夜の過ごし方' },
      gifts: { label: '装備とおみやげ', blurb: 'アウトドア装備、衣類、ラップランドのお土産' },
      nature: { label: '自然へ出かける', blurb: 'トレイル、フェル（なだらかな山）、国立公園' },
      kids: { label: '子どもと旅する', blurb: 'ファミリーリゾートとサンタクロースとの出会い' },
    },
