...
const TITLE: Record<Lang, string> = {
  ...
  sv: 'Integritetspolicy · Lapland.blog',
};
const DESCRIPTION: Record<Lang, string> = {
  ...
  es: 'Cómo trata sus datos Lapland.blog: la plataforma gratuita de blogs de viaje a la Laponia finlandesa operada por LaPeso Oy. Conforme al RGPD.',
  'pt-BR': 'Como o Lapland.blog trata seus dados: a plataforma gratuita de blogs de viagem à Lapônia finlandesa operada pela LaPeso Oy. Em conformidade com o GDPR.',
  ...
  nl: 'Hoe Lapland.blog met uw gegevens omgaat. Het gratis reisblogplatform voor Fins Lapland, beheerd door LaPeso Oy. AVG-conform.',
